...
function Page() {
  ...
  return (
    <div className="flex flex-col items-center y-gutter max-w-screen case-x-gutter">
      {/* Dynamic spacer */}
      <div
      ...
      <div ref={pageTop}></div>
      {/* Main content */}
      <div className="flex flex-col transition-all duration-300 ease-fast gap-[3rem] md:w-[80%] sm:-[w-80%] lg:w-[80%] w-full case-x-gutter bg-white y-gutter lg:pt-[12vh] pt-[4.5vh]">
        {/* //content block */}
        <div className="flex flex-col h-fit gap-[2rem] w-full">
          ...
          <div className="div flex flex-col gap-[0.5rem]">
            ...
            <h6 className="text-text-secondary">
              {" "}
              Product | Design | Dev | Seeking Summer 2026{" "}
            </h6>
          </div>
          {/* <p className='text-text-teritary' key={key}>{item}</p> */}
          <div className="flex flex-col gap-[2rem]">
            <p>
              I love to dream big. Relentlessly curious, I&apos;m positioned in
              the intersection between design, development, and business.{" "}
            </p>
            <p>
              {" "}
              Outside of design, you can find me collecting Lego Cars, Competing
              in Yugioh Tournaments, or watching Anime Power Scaling.{" "}
            </p>
          </div>
        </div>
            ...
            <div className="flex flex-row w-full justify-between">
              <div className="flex flex-row gap-[0.25rem]">
                ...
                <div className="flex flex-row gap-[0.5rem]">
                  ...
                  <p className="text-text-secondary"> B.A. Design</p>{" "}
                </div>
              </div>
              <p>2022 - 2027</p>
            </div>
        ...
        <div className="flex flex-col gap-[1rem] mt-[2rem]">
          ...
          <div className="flex flex-row gap-[0.25rem]">
            <a href="" target="_blank">
              <p className="text-underline text-text-secondary hover:text-black hover:cursor-pointer">
                / Linkedin
              </p>
            </a>
            <a href="" target="_blank">
