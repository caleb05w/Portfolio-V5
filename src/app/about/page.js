...
const ABOUT_PHOTOS = [
  {
    ...
    caption: "Late night trading session at a friend's place",
  ...
  },
  {
    ...
    alt: "New Year's",
    caption: "Dressed up for New Year's. Ear muffs were necessary.",
    object: "object-cover w-full h-full",
    imgHeight: "h-[40vh]",
  },
  {
  ...
  },
  {
    ...
    caption: "We dragged an air mattress to the rooftop. Peak summer.",
    object: "object-cover w-full h-full",
    imgHeight: "h-[40vh]",
  },
  {
    ...
    caption: "Tower Bridge with the boys. Europe trip summer '24.",
    object: "object-cover w-full h-full",
    imgHeight: "h-[40vh]",
  },
