    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='flex flex-col transition-all duration-300 ease-fast y-gutter gap-[2rem] '>
                ...
                <div className='top-0 w-screen flex flex-col gap-4 justify-center items-center'>
                    <div className='w-full flex flex-col items-center justify-center'>
                        <div className="w-full flex justify-center ">
                            <div className="w-[80%] h-fit flex flex-row justify-start gap-[1rem] md:gap-[0.6rem] lg:gap-[0.4rem] flex-wrap">
                                {cards.map((item, key) => (
                                    <div
                                        key={key}
